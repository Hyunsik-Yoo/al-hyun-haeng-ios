...
class SignInVC: BaseVC {
        ...
        func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
            if let appleIDCredential = authorization.credential as? ASAuthorizationAppleIDCredential {
                ...
                guard let appleIDToken = appleIDCredential.identityToken else {
                    AlertUtils.show(controller: self, title: "Sign with apple error",
                ...
                FirebaseUtils().auth(credential: credential) {
    ...
    extension SignInVC: LoginButtonDelegate {
        func loginButton(_ loginButton: FBLoginButton, didCompleteWith result: LoginManagerLoginResult?, error: Error?) {
            if let error = error {
                AlertUtils.show(controller: self, title: nil, message: error.localizedDescription)
            } else {
